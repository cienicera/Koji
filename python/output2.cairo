...
Message::NOTE_ON(NoteOn { channel: 0, note: 49, velocity: 100, time: FP32x32 { mag: 50, sign: false } }),
Message::NOTE_OFF(NoteOff { channel: 0, note: 49, velocity: 100, time: FP32x32 { mag: 100, sign: false } }),
Message::NOTE_OFF(NoteOff { channel: 0, note: 48, velocity: 100, time: FP32x32 { mag: 350, sign: false } })
].span()
   }
}